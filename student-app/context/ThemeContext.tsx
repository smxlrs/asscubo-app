...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    guestMode: '游客模式',
    bannedTitle: '账号已被封禁',
    bannedSubtitle: '很抱歉，您的账号已被管理员封禁。如有疑问，请联系学联管理员进行处理。',
    ...
    emailAlreadyRegistered: '该邮箱已有帐号，请直接登录。',
    forgotPassword: '忘记密码？',
    retryLogin: '重试',
    resetPassword: '重置密码',
    resetPasswordDescription: '输入注册邮箱，我们将向您发送用于重置密码的安全链接。',
    sendResetLink: '发送重置链接',
    resetLinkSent: '重置邮件已发送',
    resetLinkSentDescription: '请打开邮件中的链接返回 App，并设置新的登录密码。',
    passwordUpdated: '密码已更新，请使用新密码登录。',
    resetLinkInvalid: '重置链接无效、已过期或已被使用，请重新申请。',
    otpSentTitle: '验证码已发送',
    ...
    quickActionSetting: '快捷功能菜单',
    quickActionDescription: '在系统桌面长按应用图标时，会弹出快捷功能菜单。您可以从以下功能中选择最多 4 个进行显示：',
    quickActionMaxAlert: '最多只能选择 4 个快捷功能',
    quickActionMinAlert: '请至少选择 1 个快捷功能',
    quickActionSaveSuccess: '快捷功能设置保存成功！下次启动或返回桌面时生效。',
    quickAction_dictionary: '意汉词典',
    quickAction_dictionary_desc: '快速查询意大利语单词',
    quickAction_bus: '公交查询',
    quickAction_bus_desc: '查询博洛尼亚公交时刻表',
    quickAction_handbook: '新生手册',
    quickAction_handbook_desc: '查看博大新生入学指南',
    quickAction_train: '火车客流',
    quickAction_train_desc: '查询意大利列车实时时刻与站台',
    quickAction_classroom: '空闲教室',
    quickAction_classroom_desc: '寻找今日空闲的上课教室',
    quickAction_studyroom: '自习室',
    quickAction_studyroom_desc: '查询学校自习室开放状态',
    quickAction_articles: '精选文章',
    quickAction_articles_desc: '阅读学联精选推文',
    quickAction_announcements: '动态通知',
  ...
  en: {
    ...
    bannedSubtitle: 'We are sorry, but your account has been banned by the administrator. Please contact the admin for assistance.',
    ...
    emailRegPlaceholder: 'Please use your university email',
    ...
    emailAlreadyRegistered: 'This email already has an account. Please sign in directly.',
    forgotPassword: 'Forgot password?',
    retryLogin: 'Try Again',
    resetPassword: 'Reset Password',
    resetPasswordDescription: 'Enter your registered email and we will send a secure password-reset link.',
    sendResetLink: 'Send Reset Link',
    resetLinkSent: 'Reset Email Sent',
    resetLinkSentDescription: 'Open the link in the email to return to the app and set a new password.',
    passwordUpdated: 'Password updated. Please sign in with your new password.',
    resetLinkInvalid: 'This reset link is invalid, expired, or has already been used. Please request a new one.',
    ...
    quickActionSetting: 'Quick Actions Menu',
    quickActionDescription: 'Long-press the app icon on the home screen to display the quick actions menu. You can select up to 4 items from the list below:',
    quickActionMaxAlert: 'You can select at most 4 quick actions',
    quickActionMinAlert: 'Please select at least 1 quick action',
    quickActionSaveSuccess: 'Quick action settings saved! Take effect upon next launch or return to home.',
    quickAction_dictionary: 'Italian Dict',
    quickAction_dictionary_desc: 'Quickly look up Italian words',
    quickAction_bus: 'Bologna Bus',
    quickAction_bus_desc: 'Check Bologna bus schedules',
    quickAction_handbook: 'Handbook',
    quickAction_handbook_desc: 'Bologna student guide book',
    quickAction_train: 'Italian Trains',
    quickAction_train_desc: 'Live train board & schedules',
    quickAction_classroom: 'Free Classrooms',
    quickAction_classroom_desc: 'Find empty classrooms today',
    quickAction_studyroom: 'Study Rooms',
    quickAction_studyroom_desc: 'Check school study room status',
    quickAction_articles: 'Articles',
    quickAction_articles_desc: 'Read articles and blogs',
    quickAction_announcements: 'Announcements',
  ...
  it: {
    ...
    bannedSubtitle: 'Siamo spiacenti, ma il tuo account è stato sospeso dall\'amministratore. Si prega di contattare l\'amministratore per assistenza.',
    ...
    emailRegPlaceholder: 'Usa la tua email universitaria',
    ...
    emailAlreadyRegistered: 'Questa email ha già un account. Accedi direttamente.',
    forgotPassword: 'Password dimenticata?',
    retryLogin: 'Riprova',
    resetPassword: 'Reimposta Password',
    resetPasswordDescription: 'Inserisci l’email registrata: invieremo un link sicuro per reimpostare la password.',
    sendResetLink: 'Invia Link di Reimpostazione',
    resetLinkSent: 'Email di Reimpostazione Inviata',
    resetLinkSentDescription: 'Apri il link nell’email per tornare nell’app e impostare una nuova password.',
    passwordUpdated: 'Password aggiornata. Accedi con la nuova password.',
    resetLinkInvalid: 'Il link non è valido, è scaduto o è già stato utilizzato. Richiedine uno nuovo.',
    ...
    quickActionSetting: 'Menu Rapido',
    quickActionDescription: 'Tieni premuto l\'icona dell\'app per mostrare il menu delle azioni rapide. Puoi selezionare fino a 4 voci dal menu sottostante:',
    quickActionMaxAlert: 'Puoi selezionare al massimo 4 azioni rapide',
    quickActionMinAlert: 'Seleziona almeno 1 azione rapida',
    quickActionSaveSuccess: 'Impostazioni delle azioni rapide salvate! Avranno effetto al prossimo avvio.',
    quickAction_dictionary: 'Dizionario',
    quickAction_dictionary_desc: 'Cerca parole in italiano',
    quickAction_bus: 'Autobus Bologna',
    quickAction_bus_desc: 'Orari degli autobus a Bologna',
    quickAction_handbook: 'Guida Studenti',
    quickAction_handbook_desc: 'Guida per studenti UniBo',
    quickAction_train: 'Treni',
    quickAction_train_desc: 'Orari e stato treni in tempo reale',
    quickAction_classroom: 'Aule Libere',
    quickAction_classroom_desc: 'Trova aule vuote oggi',
    quickAction_studyroom: 'Sale Studio',
    quickAction_studyroom_desc: 'Stato delle sale studio UniBo',
    quickAction_articles: 'Articoli',
    quickAction_articles_desc: 'Leggi gli articoli consigliati',
    quickAction_announcements: 'Annunci e Avvisi',
  ...
  'zh-Hant': {
    ...
    guestMode: '遊客模式',
    bannedTitle: '帳號已被封鎖',
    bannedSubtitle: '很抱歉，您的帳號已被管理員封鎖。如有疑問，請聯絡學聯管理員進行處理。',
    ...
    emailAlreadyRegistered: '該郵箱已有帳戶，請直接登錄。',
    forgotPassword: '忘記密碼？',
    retryLogin: '重試',
    resetPassword: '重設密碼',
    resetPasswordDescription: '輸入註冊郵箱，我們將向您發送用於重設密碼的安全連結。',
    sendResetLink: '發送重設連結',
    resetLinkSent: '重設郵件已發送',
    resetLinkSentDescription: '請打開郵件中的連結返回 App，並設定新的登入密碼。',
    passwordUpdated: '密碼已更新，請使用新密碼登入。',
    resetLinkInvalid: '重設連結無效、已過期或已被使用，請重新申請。',
    otpSentTitle: '驗證碼已發送',
    ...
    quickActionSetting: '快捷功能菜單',
    quickActionDescription: '在系統桌面長按應用圖標時，會彈出快捷功能菜單。您可以從以下功能中選擇最多 4 個進行顯示：',
    quickActionMaxAlert: '最多只能選擇 4 個快捷功能',
    quickActionMinAlert: '請至少選擇 1 個快捷功能',
    quickActionSaveSuccess: '快捷功能設置保存成功！下次啟動或返回桌面時生效。',
    quickAction_dictionary: '意漢詞典',
    quickAction_dictionary_desc: '快速查詢意大利語單詞',
    quickAction_bus: '公交查詢',
    quickAction_bus_desc: '查詢博洛尼亞公交時刻表',
    quickAction_handbook: '新生手冊',
    quickAction_handbook_desc: '查看博大新生入學指南',
    quickAction_train: '火車客流',
    quickAction_train_desc: '查詢意大利列車實時時刻與站台',
    quickAction_classroom: '空閒教室',
    quickAction_classroom_desc: '尋找今日空閒的上課教室',
    quickAction_studyroom: '自習室',
    quickAction_studyroom_desc: '查詢學校自習室開放狀態',
    quickAction_articles: '精選文章',
    quickAction_articles_desc: '閱讀學聯精選推文',
    quickAction_announcements: '動態通知',
