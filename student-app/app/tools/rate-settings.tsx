...
const COPY = {
  zh: {
    title: '显示货币', search: '搜索国家、货币或代码', selected: '已显示 {count} 种货币', note: '按旅行及日常使用频率排序；未选货币不会出现在换算页面。', atLeastOne: '请至少保留一种货币。',
  },
  'zh-Hant': {
    title: '顯示貨幣', search: '搜尋國家、貨幣或代碼', selected: '已顯示 {count} 種貨幣', note: '按旅行及日常使用頻率排序；未選貨幣不會出現在換算頁面。', atLeastOne: '請至少保留一種貨幣。',
  },
  en: {
    title: 'Display currencies', search: 'Search country, currency, or code', selected: '{count} currencies shown', note: 'Ordered by travel and everyday-use frequency. Hidden currencies stay out of the converter.', atLeastOne: 'Keep at least one currency selected.',
  },
  it: {
    title: 'Valute visualizzate', search: 'Cerca paese, valuta o codice', selected: '{count} valute visualizzate', note: 'Ordinate per frequenza di viaggio e uso quotidiano. Le valute non selezionate non appaiono nel convertitore.', atLeastOne: 'Mantieni selezionata almeno una valuta.',
  },
};
