...
const LOCALIZED = {
  zh: {
    ...
    sec4Body: '博洛尼亚大学中国学生学者联谊会（Associazione di Studenti e Studiosi Cinesi dell\'Università di Bologna）是在博洛尼亚大学正式注册的非营利性中国学生学者组织，也是接受中国驻意大利大使馆科教处指导的学生团体。学联自成立以来，始终秉承致力于促进中国留学生同当地学生之间的交流并维护在意留学生的权益；为就读于博洛尼亚大学的留学生提供必要的帮助与服务；为广大留学生营造良好的学习环境的宗旨。博学平台是我们践行数字化便利服务的重要载体，欢迎每一位在博学子向我们反馈宝贵的使用意见。'
  },
  'zh-Hant': {
    title: '平台簡介',
    ...
    sec4Body: '博洛尼亞大學中国学生学者联谊会（Associazione di Studenti e Studiosi Cinesi dell\'Università di Bologna）是在博洛尼亞大學正式註冊的非營利性中國學生學者組織，也是接受中國駐意大利大使館科教處指導的學生團體。學聯自成立以來，始終秉承致力於促進中國留學生同當地學生之間的交流並維護在意留學生的權益；為就讀於博洛尼亞大學的留學生提供必要的幫助與服務；為廣大留學生營造良好的學習環境的宗旨。博學平台是我們踐行數位化便利服務重要載體，歡迎每一位在博學子向我們反饋寶貴的使用意見。'
  },
  en: {
