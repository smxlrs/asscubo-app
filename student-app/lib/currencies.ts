...
export const CURRENCY_OPTIONS: CurrencyOption[] = [
  ...
  { code: 'HKD', flag: '🇭🇰', continent: '亚洲', countryName: '中国香港 / Hong Kong, China', currencyName: '港币 / Hong Kong Dollar', searchTerms: 'hkd 香港 hong kong 港币 dollar' },
  { code: 'MOP', flag: '🇲🇴', continent: '亚洲', countryName: '中国澳门 / Macao, China', currencyName: '澳门元 / Macanese Pataca', searchTerms: 'mop 澳门 macao macau 澳门元 pataca' },
  { code: 'TWD', flag: '🇨🇳', continent: '亚洲', countryName: '中国台湾 / Taiwan, China', currencyName: '新台币 / New Taiwan Dollar', searchTerms: 'twd 台湾 taiwan 新台币 dollar' },
